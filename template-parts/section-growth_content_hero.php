...
<section class="section-growth-community section-growth-content no-padding section4"
   id = "section4">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-5">
                <div class="content-outer-container"  style="background-image: url('<?php echo $content['background_image'] ?>')" >
                    ...
                    <div class="button-container">
                        <a href="<?php echo $content['button_link']['url'] ?>"><button
                                class="btn btn-primary btn-white-bg  btn-arrow btn-small">
