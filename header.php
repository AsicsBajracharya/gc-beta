...
?>
	...
	<!-- Google tag (gtag.js) --> 
	<script async src="https://www.googletagmanager.com/gtag/js?id=G-BJ7ZHW9DQT">
	    
	</script> 
	<script>


	var user_id = '<?php echo $_SESSION['data']; ?>';
		//console.log(user_id);
    	window.dataLayer = window.dataLayer || []; 
    	function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-BJ7ZHW9DQT',  {'user_id': user_id}); 
	</script>
